            ...
            [
                {
                    "name": "fs.list",
                    "namespace": "fs",
                    "group_path": default_group_path("fs.list"),
                ...
                },
                {
                    "name": "fs.read_text",
                    "namespace": "fs",
                    "group_path": default_group_path("fs.read_text"),
                ...
                },
                {
                    "name": "fs.write_text",
                    "namespace": "fs",
                    "group_path": default_group_path("fs.write_text"),
                ...
                },
                {
                    "name": "fs.mkdir",
                    "namespace": "fs",
                    "group_path": default_group_path("fs.mkdir"),
                ...
                },
                {
                    "name": "fs.stat",
                    "namespace": "fs",
                    "group_path": default_group_path("fs.stat"),
        ...
        methods.append(
            {
                "name": "http.fetch",
                "namespace": "http",
                "group_path": default_group_path("http.fetch"),
