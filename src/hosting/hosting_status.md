...
| DOC/TEST-R9.6B | The handoff is now an implementation-ordered dependent-consumer migration guide: old-to-new surfaces, exact shipped typed payloads, dependent file map, checklist, required suites, and receipt fields. Parent execution history and implementation-only details were removed; guide, typed-channel, and related durable-doc coverage passed 54 tests. |
