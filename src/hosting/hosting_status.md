...
Move intrinsic dependency declarations into read-only metadata and implement the
source analyzer/resolver/template selection pipeline from P1-03 through P1-06.
