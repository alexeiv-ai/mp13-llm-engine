...
R2-02b (`high`) is validated and ready for its isolated commit, completing
R2-02. After the commit and clean-worktree check, declare R2-03a (`high`)
active. Its boundary removes shipped realized lock resources and the
lock-JSON-as-wheel bridge in favor of strict release-owned built-in intents.
