...
from tests.hosting_v3_fixtures import (
    hosting_configuration as v3_hosting_configuration,
    write_hosting_configuration,
)
...
def test_hosted_toolbox_ref_serializes_and_deserializes_with_service() -> None:
    ...
    try:
        ...
        payload = ref.to_dict()
        restored = HostedToolBoxRef.from_dict(payload, host=svc)

        assert payload["host"] == {
            "host_type": "EngineHostService",
            "kind": "service",
        }
        assert restored.host is svc
